...
//#region node_modules/.pnpm/@csstools+convert-colors@2.0.1/node_modules/@csstools/convert-colors/index.mjs
...
var c = 1e8, a = (n, t) => s$1(h(n, t)), l = (n) => p(f(n)), f = (n) => n * w / 180, s$1 = (n) => 180 * n / w, d = (n) => I(f(n)), g = Math.abs, h = Math.atan2, m = Math.cbrt, p = Math.cos, y = Math.exp, b = Math.floor, k = Math.max, v = Math.min, w = Math.PI, M = Math.pow, I = Math.sin, q = Math.sqrt, S = M(6, 3) / M(29, 3), A = M(29, 3) / M(3, 3);
function J(n, t) {
	return function(n, t) {
...
var N = (n) => n <= 3.928 ? n / R : Q(n), Q = (n) => M((n + 5.5) / 105.5, 2.4), R = 1292, V = .2126 * c, W = .7152 * c, X = .0722 * c;
function Y(n) {
...
var _ = /^#?(?:([a-f0-9])([a-f0-9])([a-f0-9])([a-f0-9])?|([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?)$/i;
function _n(n, t) {
	return J(Y(n), Y(t));
}
//#endregion
//#region node_modules/.pnpm/react-icon-cloud@4.1.7_react@19.2.7/node_modules/react-icon-cloud/dist/react-icon-cloud.esm.js
...
var UseInViewport = function UseInViewport(_ref) {
	...
	import_react.useEffect(function() {
		var observer = new IntersectionObserver(function wrappedCb(entries) {
		...
		if (ref != null && ref.current) observer.observe(ref.current);
		return function() {
			observer.disconnect();
		};
	}, [cb]);
	return import_react.createElement("div", { ref }, children);
};
...
var CloudWrapped = function CloudWrapped(_ref) {
	...
	var state = import_react.useRef({
		canvasContainerId: "canvas-container-" + id,
		canvasId: "canvas-" + id,
		hasStarted: false
	}).current;
	var _React$useState = import_react.useState(false), mounted = _React$useState[0], setMounted = _React$useState[1];
	import_react.useEffect(function() {
		setMounted(true);
		return function() {
			return tr(function() {
	...
	var onVisibilityChange = function onVisibilityChange(isVisible) {
		return tr(function() {
			if (isVisible && mounted) {
				...
				if (state.hasStarted) eval("TagCanvas.Resume('" + state.canvasId + "')");
				else try {
			...
			} else if (state.hasStarted) eval("TagCanvas.Pause('" + state.canvasId + "')");
		});
	};
	return import_react.createElement(UseInViewport, { cb: onVisibilityChange }, import_react.createElement("div", Object.assign({ id: state.canvasContainerId }, containerProps), import_react.createElement("canvas", Object.assign({
		id: state.canvasId,
		style: {
			width: "100%",
			maxWidth: "70vh"
...
var Cloud = function Cloud(props) {
	return import_react.createElement(CloudWrapped, Object.assign({}, props, { key: guid() }));
};
...
var renderSimpleIcon = function renderSimpleIcon(_ref) {
	...
	var _rgb$map = (_n(bgHexHash, originalHex) > minContrastRatio ? Y(originalHex) : Y(fallbackHexHash)).map(function(percent) {
	...
	return import_react.createElement("a", Object.assign({}, a), import_react.createElement("img", Object.assign({}, i)));
};
		...
		return _regeneratorRuntime().wrap(function _callee$(_context) {
			while (1) switch (_context.prev = _context.next) {
				case 0:
					...
					_context.next = 5;
					return fetch(urlSlug, { cache: "force-cache" });
				case 5:
					res = _context.sent;
					_context.next = 8;
					return res.text();
				...
				case 17: return _context.abrupt("return", fallback);
				case 18:
	...
	var _ref2 = /*#__PURE__*/ _asyncToGenerator(/*#__PURE__*/ _regeneratorRuntime().mark(function _callee2(slugs) {
		...
		return _regeneratorRuntime().wrap(function _callee2$(_context2) {
			while (1) switch (_context2.prev = _context2.next) {
				...
				case 4: return _context2.abrupt("return", slugs.map(function(slug) {
					var _cache$slug;
					return {
						slug,
...
var getSlug = function getSlug(_ref) {
	return _ref.title.toLowerCase().replace(TITLE_TO_SLUG_CHARS_REGEX, function(_char) {
		...
		return _regeneratorRuntime().wrap(function _callee$(_context) {
			while (1) switch (_context.prev = _context.next) {
				case 0:
					...
					_context.prev = 1;
					_context.next = 4;
					return fetch(url$1, { cache: "force-cache" });
				case 4:
					res = _context.sent;
					_context.next = 7;
					return res.json();
				case 7:
					...
					json.forEach(function(icon) {
						var _icon$hex;
						var iconSlug = getSlug({ title: icon.title });
						cache$1[iconSlug] = {
		...
		return _regeneratorRuntime().wrap(function _callee2$(_context2) {
			while (1) switch (_context2.prev = _context2.next) {
				case 0:
					_context2.next = 2;
					return primeCache();
				case 2: return _context2.abrupt("return", {
